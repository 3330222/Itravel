    ...
    <table>
	    ...
	    <tr>
	      ...
	      <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="black"><b>Type</b></font></div></td>
	       <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="black"><b>Gender</b></font></div></td>
	      <td width="10%" nowrap bgcolor="6f8ac4"> <div align="center"><font color="black"><b>Email</b></font></div></td>
	       <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="black"><b>Status</b></font></div></td>
	    </tr>
	   ...
	   <c:forEach items="${vo.pageView.records}" var="entry">
	    <tr>
	      ...
	      <td bgcolor="#F1F1F1" width="10%"> <div align="center"><laps:codetable codeTypeCd="GenderCd" codeValue="${entry.gender}" /></div></td>
	      <td bgcolor="#F1F1F1" width="10%"> <div align="center">${entry.email}</div></td>
	      <td bgcolor="#F1F1F1" width="10%"> <div align="center"><laps:codetable codeTypeCd="EmployeeStatusCd" codeValue="${entry.status}" /></div></td>
	    ...
	    <tr >
	       <td colspan="6">
	          <input size="8" name="add" type="button" class="frm_btn" id="add" onclick="toPage('/laps/business/employee/enterCreateEmployee')" value="add"> &nbsp;&nbsp;
