 ...
 <div class="col-md-1"></div>
  <div class="col-md-6"style="padding-right:2em;">
     <div class="user_content">
        <form:form id="form" method="post" action="/user/register/traveller"  commandName="vo" >
...
function validateAccount(){
	...
	$.when(aynchQueryAccount())
	        .done(function() {
	        	console.info("aynchQueryAccount done");
	});
...
function validateForm(){
	var validateResult = validateAccount()&&validateConfirmedPassword()&&validateEmail();
	accountResult = false;
