...
<STYLE type=text/css>.top {
	FONT-SIZE: 9pt; VERTICAL-ALIGN: bottom; PADDING-TOP: 0px; FONT-FAMILY: "fantasy"; 666600: 
}
BODY {
	MARGIN-TOP: 0px; FONT-SIZE: 9pt; MARGIN-LEFT: 0px; COLOR: #ffffff; LINE-HEIGHT: 150%; MARGIN-RIGHT: 0px; FONT-FAMILY: "fantasy"; BACKGROUND-COLOR: #ffffff ;
      ...
      bgColor=#f33800 border=0>
        ...
        <TR vAlign=bottom height=20>
          <TD width=18></TD>
            ...
            <TD class=top bgColor=#f33800><NOBR>welcome 
              <c:if test="${!empty user}">
                  <laps:codetable codeTypeCd="EmployeeTypeCd" codeValue="${user.employeeType }"/>
                  <c:out value='${user.employeeName}'/>
               </c:if>| current date <%=formatter.format(dNow) %></NOBR>
              </TD>
            </TR>
        <TR height=38>
          <TD></TD>
          <TD vAlign=center align=right>
            ...
            title="fresh" onmouseout="MM_nbGroup('out');" 
            href="javascript:parent.mainframe.location.reload()"><IMG 
            src="/laps/images/refresh.png"></A> &nbsp; <A 
            onmouseover="MM_nbGroup('over','OAHeader_r1_c7','/images/OAHeader_r1_c7_f2.gif','/image/OAHeader_r1_c7_f3.gif',1);" 
            title="prev" onmouseout="MM_nbGroup('out');" 
            href="javascript:history.back()"><IMG src="/laps/images/prev.png"></A> &nbsp; <A 
            onmouseover="MM_nbGroup('over','OAHeader_r1_c9','/images/OAHeader_r1_c9_f2.gif','/image/OAHeader_r1_c9_f3.gif',1);" 
            title="next" onmouseout="MM_nbGroup('out');" href="javascript:history.forward()"><IMG 
            src="/laps/images/next.png"></A> &nbsp; <A 
            onmouseover="MM_nbGroup('over','OAHeader_r1_c11','/images/OAHeader_r1_c11_f2.gif','/image/OAHeader_r1_c11_f3.gif',1);" 
            title="log out" onmouseout="MM_nbGroup('out');" 
            href="javascript:exitsystem('<c:url value="/login/logout"/>')"><IMG 
            src="/laps/images/exit.png"></A> &nbsp; 
